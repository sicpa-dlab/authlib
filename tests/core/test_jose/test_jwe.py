...
from authlib.jose.errors import InvalidEncryptionAlgorithmForECDH1PUWithKeyWrappingError, KeyMismatchError, \
    InvalidAlgorithmForMultipleRecipientsMode, DecodeError
